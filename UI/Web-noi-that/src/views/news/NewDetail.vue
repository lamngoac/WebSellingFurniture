...
<div>
    <section class="section_breacrumb">
        <div class="container">
            <ul class="breadcrumb clearfix" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                ...
                <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                    <a itemprop="item" href="">
                        <span itemprop="name">Chi tiết tin tức</span>
                    </a>
    ...
    <section class="section news-detail container">
        <div class="row">
            <div class="col-lg-9 col-12" v-if="news">
                <div class="news-detail__content border-bottom pb-lg-4 pb-md-3 pb-2">
                    ...
                    <div class="news__item__author wow fadeInUp">
                        ...
                        <span class="_date ms-lg-3 ms-md-2 ms-1">
                            ...
                            {{ news.createdDate | moment("DD/MM/YYYY") }}
                        </span>
                    </div>
                    <div class="news-detail__post wow fadeInUp s-content">
                        <img v-if="news.linkImage" :src="require('@/assets/content/images/' + news.linkImage)" class="img-fluid" />
              ...
              ">
                 ...
                 <comment :id="news.newsId"></comment>
            </div>
            <div class="col-lg-3 col-12">
                <div class="hot-news mb-lg-5 mb-lg-4 mb-md-3 mb-2 wow fadeInUp">
                    ...
                    <div class="row row-cols-lg-1 row-cols-2 gy-3">
                        <div v-for="(data,index) in newsHot" :key="index"  class="col wow bounceIn" :data-wow-delay="`${index * 0.1}` + 's'" data-wow-duration="1s">
                            <div class="hot-news__item border-bottom" @click="viewNews(data.newsId)">
                                <a class="_link fw-bold d-block mb-lg-2">{{data.newsTitle}}</a>
    ...
    <section class="section related-news">
        <div class="container">
            ...
            <div class="row related-news__list gy-3 gx-3">
                <div v-for="(data,index) in newsRelateTo" :key="index" class="col-lg-4 col-sm-6 col-12 related-news__item wow fadeInUp" data-wow-delay="<?php echo $i*0.1; ?>s" data-wow-duration="1s">
                    <a class="_img-link d-block" title="" @click="viewNews(data.newsId)">
                    ...
                    <a href="" class="_title d-block mb-lg-3 mb-2" title="">{{data.newsTitle}}</a>
                    <div class="_short">
                          {{ data.newsContent }}
                    </div>
                </div>
...
export default {
    ...
    async created() {
        ...
        if (me.$route && me.$route.params && me.$route.params.id) {
            let res = await me.getNewsById(me.$route.params.id);
            if (res) {
                me.news = {
                    ...res,
                };
    ...
    methods: {
        ...
        async getData() {
            const me = this;
            me.newsRelateTo = await me.getNewsHome();
            me.newsHot = await me.getNewsHot();
        },
        async viewNews(id) {
            const me = this;
...
<style scoped>
.related-news .related-news__list ._short{
  overflow: hidden;
